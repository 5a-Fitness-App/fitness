...
INSERT INTO users (user_name, user_dob, user_weight, user_email, user_password) VALUES
...
INSERT INTO workouts (user_ID, workout_title, workout_date_time, workout_duration, workout_calories_burnt) VALUES
...
INSERT INTO activities (workout_ID, exercise_ID, activity_name, activity_type, activity_distance, activity_elevation) VALUES
...
(2, 1, CURRENT_TIMESTAMP), -- Jane likes John's workout
(3, 2, CURRENT_TIMESTAMP), -- Mike likes Jane's workout
(1, 3, CURRENT_TIMESTAMP), -- John likes Mike's workout
(4, 4, CURRENT_TIMESTAMP), -- Alice likes her own workout
(5, 5, CURRENT_TIMESTAMP); -- Bob likes his own workout


INSERT INTO comments (user_ID, workout_ID, content, date_commented) VALUES
...
INSERT INTO workout_comments (workout_ID, comment_ID) VALUES
(1, 1),
(2, 2),
(3, 3),
(4, 4),
...
INSERT INTO friends (user_ID, friend_ID, friend_date) VALUES
(1, 2, CURRENT_TIMESTAMP), -- John and Jane are friends
(2, 3, CURRENT_TIMESTAMP), -- Jane and Mike are friends
(3, 4, CURRENT_TIMESTAMP), -- Mike and Alice are friends
(4, 5, CURRENT_TIMESTAMP), -- Alice and Bob are friends
(1, 5, CURRENT_TIMESTAMP); -- John and Bob are friends


INSERT INTO friend_requests (sender_ID, reciever_ID, request_date) VALUES
(1, 3, CURRENT_TIMESTAMP), -- John sends request to Mike
(2, 5, CURRENT_TIMESTAMP), -- Jane sends request to Bob
(4, 1, CURRENT_TIMESTAMP), -- Alice sends request to John
