...
('legs', 'glutes', 'chest', 'back', 'shoulders', 'biceps', 'triceps', 'core', 'cardio');
CREATE TYPE distance_metric_enum AS ENUM
('Miles', 'km');
...
-- USERS
INSERT INTO users
    (user_name, user_profile_photo, user_bio, user_dob, user_weight, user_units, users_account_creation_date, user_email, user_password)
VALUES
...
INSERT INTO workouts
    (user_ID, workout_title, workout_date_time, workout_public)
VALUES
    -- Alice
